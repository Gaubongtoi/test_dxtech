...
function HomePage() {
    ...
    return (
        <>
            ...
            >
                <div className="bg-primary_black text-white rounded-[45px] p-16 flex justify-between border-2 mt-10 gap-10 text-xl">
                    <div className="w-1/3">
                        <p>
                        ...
                        <a href="#" className="text-primary_green flex items-center gap-2 mt-4">
